            ...
            <div class="box-body">
              <table id="tableOwner" class="table table-borderless table-hover">
                ...
                <tr>
                  ...
                  <th style="font-size: 13px" width="130">MANDANTE</th>
                  <th style="font-size: 13px" width="130">DATOS PROSPECTO</th>
                  <th style="font-size: 13px" width="150">INFORMACIÓN</th>
                  <th style="font-size: 13px" width="130">DATOS PROPIEDAD</th>
          ...
          <form id="addOwner" method="POST">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" id="name_owner" name="name_owner" class="form-control" placeholder="INGRESAR NOMBRE PROPIETARIO">
              </div>
              <!-- /.input group -->
            </div>
...
<!-- Script Custom -->
<script src="resources/dist/js/gestion.visit.js"></script>
<!-- Moment.js -->
