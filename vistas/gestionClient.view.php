      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-default box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tableOwner" class="table table-borderless table-hover">
                <thead>
                <tr>
                  <th style="font-size: 13px" width="10">#</th>
                  <th style="font-size: 13px" width="130">NOMBRE CLIENTE</th>
                  <th style="font-size: 13px" width="130">RUT CLIENTE</th>
                  <th style="font-size: 13px" width="150">NÚMERO DE CLIENTE</th>
                  <th style="font-size: 13px" width="130">CORREO CLIENTE</th>
    ...
    <div class="modal-dialog" role="document" style="width: 400px">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center" id="myModalLabel">REGISTRO DE CLIENTE</h4>
        </div>
          ...
          <form id="addOwner" method="POST">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <select id="owner_group" name="owner_group" class="select2 form-control">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" id="name_owner" name="name_owner" class="form-control" placeholder="INGRESAR NOMBRE CLIENTE" autocomplete="off">
              </div>
              <!-- /.input group -->
            </div>
            ...
            <div class="modal-footer">
              ...
              <button id="btnModify" type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i> Crear Cliente</button>
            </div>
          </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modalEditOwner" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width: 400px">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title text-center" id="myModalLabel">ACTUALIZAR CLIENTE</h4>
        </div>
        <div class="modal-body">
          <form id="editOwner" method="POST">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
              <button id="btnModify" type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i> Actualizar Cliente</button>
            </div>
          </form>
      </div>
    </div>
...
<!-- Script Custom -->
<script src="resources/dist/js/gestion.client.js"></script>
</body>
</html>