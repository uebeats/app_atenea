...
<div class="page" style="font-size: 7pt">
  <table style="width: 100%;" class="header">
    <tbody>
      <tr>
        <td><h1 style="text-align: left"><img src="resources/dist/img/logo-negro.png"></h1></td>
        <td><h1 style="text-align: right; font-weight:normal;"><i>"Damos valor a tu Propiedad"</i></h1></td>
      </tr>
    </tbody>
  </table>
  ...
  <table style="width: 100%;" class="header">
    <tbody>
      <tr>
        <td><h1 style="text-align: left">ORDEN DE VISITA</h1></td>
        <td><h1 style="text-align: right">OV: 000-000</h1></td>
      </tr>
    </tbody>
  </table>
...
<table style="width: 100%; font-size: 8pt;">
  <tbody>
    <tr>
      <td>Agente: <strong>Gonzalo León</strong></td>
      <td>Cliente: <strong>Palmer</strong></td>
    </tr>

    <tr>
      <td>Fecha de Visita: <strong>2004-08-13</strong></td>
      <td>Correo Electrónico: <strong>2004-08-16  9:28 AM</strong></td>
    </tr>

    <tr>
      <td>Hora de Visita: <strong>667 Pine Lodge Dr.</strong></td>
      <td>Teléfono: <strong>N/A</strong></td>
    </tr>
  </tbody>
</table>
...
<table class="change_order_items">
  ...
  <tbody>
    <tr>
      <td colspan="6">
        <h2 style="margin-bottom: 0">Nota Importante:</h2>
        La visita será guiada por <b>Gonzalo León</b>; si Ud. tiene algún inconveniente para llegar a la dirección señalada y hora fijada, por favor ponerse en contacto al +56 9 7774 2140.
      </td>
    </tr>
  </tbody>
