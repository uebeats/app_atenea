...
<?php
    ...
    try {
        ...
        $mail->Subject = 'Nota de Cobro';
        $mail->Body    = '<b>Estimado Cliente,</b><br>Junto con saludar, le indicamos que hemos adjuntado a este correo electronico la Nota de Cobro N°'.$number.'.<br> Si tiene alguna duda, consulta o sugerencia, puede responder a este correo electronico o llamar a los telefonos indicados en la firma.<br><small>************ Si usted ya cancelo lo adeudado, favor omitir esta informacion ************</small><br><br>
