<?php
	...
	if (isset($num)) {
		...
		while($rw = $res->fetch_assoc()){
			...
			$query = "INSERT INTO tbl_detalle_chargenote (id_number_paynote, tmp_description, tmp_quantity, tmp_amount, tmp_detalle_mov) VALUES ('$num','$desc','$qty','$amount','$tmp_desc')";
