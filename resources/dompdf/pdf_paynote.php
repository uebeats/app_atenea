    				...
    				<table class="change_order_history">
    					...
    					<tbody style="font-size: 12px">
    						...
    						<?php
						        ...
						        $select = "SELECT * FROM tbl_paynote_system WHERE id_property = '$id' ORDER BY number_paynote DESC LIMIT 3";
						        $result = $con->query($select);
...
<?php
    ...
    $dompdf->stream("Nota de Pago - N°". $rw_paynote['number_paynote'] ." - ". $name ."", array("Attachment" => 0));
